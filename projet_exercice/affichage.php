...
<body>
    <div class="container">
        <div class="row">
            <div class="col-8">
                <div class="row">
                    <div class="col-8"><div id="message" class="col-8 text-light bg-dark">Bonjour Hiba !</div></div>
                ...
                <table class="table mt-4 " id="table-employe">
                    ...
                    <tr>
                        <th class="text-light bg-dark">Nationalité</th><td class="text-dark bg-light"><?php echo $post['nationalite']; ?></td>
                    </tr>

                    <tr>
                        <th class="text-light bg-dark">Ville</th><td class="text-dark bg-light"><?php echo $post['ville']; ?></td>
                    </tr>

                    <tr>
                        <th class="text-light bg-dark">Adresse</th><td class="text-dark bg-light"><?php echo $post['adresse']; ?></td>
                    </tr>

                    <tr>
                        <th class="text-light bg-dark">Matiere</th><td class="text-dark bg-light"><?php echo $post['matiere']; ?></td>
                    </tr>
